...
- 错题体系：SRS(`srsBox/srsDue/cleared/clearedAt`，错3天回炉/对进7天档/连对两次攻克) · 错因 `cause` 字段 · `mistakePointOf` 知识点归集 · `startSimilarPractice` 练类似题 · `buildMistakeReport/copyMistakeReport/exportMistakeReport` 汇总复制/导出TXT · 进度页"本周错因分析"。
